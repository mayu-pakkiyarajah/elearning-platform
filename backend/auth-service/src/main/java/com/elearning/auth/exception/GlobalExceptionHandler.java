package com.elearning.auth.exception;

import com.elearning.auth.dto.response.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InvalidResetTokenException.class, IllegalArgumentException.class})
