...
import com.elearning.enrollment.security.JwtAuthenticationFilter;
...
/**
 * Unlike course-service, nothing here is public — every enrollment/progress
 * endpoint is about a specific student's own record, so everything requires a
 * valid JWT. Role-specific checks (STUDENT enrolls, INSTRUCTOR views their
 * course's roster) are @PreAuthorize on the controller methods themselves.
 */
@Configuration
@EnableWebSecurity
