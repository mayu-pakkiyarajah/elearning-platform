...
import com.elearning.course.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // catalog browsing is public — no login required to window-shop courses
                ...
                // explicit JSON error bodies for both cases, matching the same
                // ApiErrorResponse shape GlobalExceptionHandler uses everywhere else
